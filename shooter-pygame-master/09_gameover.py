...
#
#
#RECORDAR CAMBIAR EL RANDOM POR LOS METEORITOS
#
#
...
class Explosion(pygame.sprite.Sprite):
	def __init__(self, center):
		...
		self.frame_rate = 50 # ESTO ES PARA EL SIGUIENTE FRAME E INDICA LA VELOCIDAD DE EXPLOSION
	...
	def update(self):
		...
		if now - self.last_update > self.frame_rate:
			...
			if self.frame == len(explosion_anim):
				self.kill() # ESTO ES PARA MORIR Y VOLVER A LA PANTALLA PRINCIPAL
			else:
...
while running:
	...
	# colision de meteoritos con el laser - laser
